...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Administradorda Faculdade'];
  const customerRoles: string[] = ['Estudante'];
  const tenantRoles: string[] = ['Professor'];
  const addOns: string[] = ['file'];
  const applicationName = `Notas`;
  const tenantName = `University`;
